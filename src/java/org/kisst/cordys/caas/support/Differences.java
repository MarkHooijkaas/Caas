...
public class Differences {
	...
	public Differences(Differences parent, String name, CordysObject o1, CordysObject o2) {
		this.parent=parent;
		if (parent==null) {
			this.name1=o1.getClass().getSimpleName()+"("+o1.getName()+")";
			this.name2=o2.getClass().getSimpleName()+"("+o2.getName()+")";
		}
		else {
			this.name1=parent.name1+name;
			this.name2=parent.name2+name;
		}
		this.o1=o1;
		this.o2=o2;
	}
	...
	public void toString(StringBuilder result, String prefix) {
		...
		for (AttributeDiff d: attribs)
			result.append(prefix+"DIFF "+name1+"."+d.name+"="+d.v1+"<=>"+name2+"."+d.name+"="+d.v2+"\n");
